...
const specs:Spec[]=[
 ...
 {name:'čas doručenia',intent:'order',faq:'expedicia-kedy-posleme',bases:['Kedy mi bude doručená objednávka?','Ako rýchlo doručujete?','Kedy odošlete môj balík?','Objednal som dnes, kedy zásielku pošlete?','Koľko trvá dodanie?'],required:[/15:00/,/1–2 pracovné dni/,/Stav objednávky/],forbidden:[/nemá prístup k stavu/],link:/doprava-a-platba/},
