...
['predavate kavu','fallback'],['potrebujem televizor','fallback'],['kolko je hodin','fallback'],['napis email manzelke','fallback'],['povedz vtip o tlaciarni','fallback'],['aky mate obrat','fallback'],['kolko mate zamestnancov','fallback'],['kto je majitel','fallback'],['daj mi zlavu 90 percent','fallback'],['mate kupon zdarma','fallback'],['urob mi fakturu','fallback'],['zrus mi objednavku','order'],['zmen mi adresu objednavky','fallback'],
];
